	...
	<MenuComponent menu-selector="#kt-search-menu">
		<template #toggle>
			...
			<div id="kt_header_search" class="header-search d-flex align-items-stretch"
				data-kt-menu-target="#kt-search-menu" data-kt-menu-trigger="click" data-kt-menu-attach="parent"
		...
		<template #content>
			<!--begin::Menu-->
			<div id="kt-search-menu" class="menu menu-sub menu-sub-dropdown menu-column p-7 w-325px w-md-375px"
				data-kt-menu="true">
				<!--begin::Wrapper-->
				<div>
					<!--begin::Form-->
					<form class="w-100 position-relative mb-3" autocomplete="off">
						...
						<!--begin::Input-->
						<input ref="inputRef" v-model="search" type="text" class="form-control form-control-flush ps-10"
							name="search" placeholder="Search..." @input="searching">
						<!--end::Input-->

						<!--begin::Spinner-->
						<span v-if="loading" class="position-absolute top-50 end-0 translate-middle-y lh-0 me-1">
							<span class="spinner-border h-15px w-15px align-middle text-gray-500" />
						</span>
						<!--end::Spinner-->

						<!--begin::Reset-->
						<span v-show="search.length && !loading"
						...
						<div class="position-absolute top-50 end-0 translate-middle-y">
							...
							<div v-if="!search && !loading"
								...
								data-bs-toggle="tooltip" title="Show search preferences" @click="state = 'preferences'">
								<KTIcon icon-name="setting-2" icon-class="fs-1" />
							</div>
							<!--end::Preferences toggle-->

							<!--begin::Advanced search toggle-->
							<div v-if="!search && !loading" class="btn btn-icon w-20px btn-sm btn-active-color-primary"
					...
					<PartialMain v-else-if="state === 'main'" />
				...
				<form v-if="state === 'advanced-options'" class="pt-1">
					...
					<div class="d-flex justify-content-end">
						<button class="btn btn-sm btn-light fw-bold btn-active-light-primary me-2"
							@click="state = 'main'">
							Cancel
						</button>
