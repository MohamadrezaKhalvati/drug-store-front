<template>
	<div class="row g-5 g-xxl-8">
		<div class="col-xl-6">
			<KTWidget1 widget-classes="mb-5 mb-xxl-8" />
			<KTWidget2 widget-classes="mb-5 mb-xxl-8" />
			<KTWidget3 widget-classes="mb-5 mb-xxl-8" />
			<KTWidget4 widget-classes="mb-5 mb-xxl-8" />
			<KTWidget5 widget-classes="mb-5 mb-xxl-8" />
			<KTWidget6 widget-classes="mb-5 mb-xxl-8" />
		</div>

		<div class="col-xl-6">
			<KTChartWidget1 widget-classes="mb-5 mb-xxl-8" />

			<KTListWidget5 widget-classes="mb-5 mb-xxl-8" />

			<KTEngageWidget1 widget-classes="mb-5 mb-xxl-8" />
		</div>
	</div>
</template>

<script lang="ts">
import KTChartWidget1 from '@/components/widgets/charts/AverageDailySales.vue'
