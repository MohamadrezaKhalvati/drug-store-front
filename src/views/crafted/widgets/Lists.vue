<template>
	...
	<div class="row g-5 g-xl-8">
		...
		<div class="col-xl-4">
			<TopUsers widget-classes="card-xl-stretch mb-xl-8"></TopUsers>
		</div>
		<div class="col-xl-4">
			<ListsWidget3 widget-classes="card-xl-stretch mb-5 mb-xl-8"></ListsWidget3>
		</div>
	</div>
	<!--end::Row-->
	...
	<div class="row g-5 g-xl-8">
		...
		<div class="col-xl-4">
			<ListsWidget6 widget-classes="card-xl-stretch mb-5 mb-xl-8"></ListsWidget6>
		</div>
	</div>
	<!--end::Row-->
	...
	<div class="row g-5 g-xl-8">
		...
		<div class="col-xl-6">
			<ListsWidget8 widget-classes="card-xl-stretch mb-5 mb-xl-8"></ListsWidget8>
		</div>
	</div>
	<!--end::Row-->
</template>
