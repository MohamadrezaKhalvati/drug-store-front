				...
				<div class="card-body border-top p-9">
						...
						<div class="col-lg-8">
							...
							<div class="row">
								...
								<div class="col-lg-6 fv-row">
									<Field v-model="profileDetails.name" type="text" name="fname"
								...
								<!--begin::Col-->
								<div class="col-lg-6 fv-row">
									<Field v-model="profileDetails.surname" type="text" name="lname"
					...
					<div class="row mb-6">
						...
						<div class="col-lg-8 fv-row">
							<Field v-model="profileDetails.company" type="text" name="company"
					...
					<div class="row mb-6">
						...
						<!--begin::Col-->
						<div class="col-lg-8 fv-row">
							<Field v-model="profileDetails.contactPhone" type="tel" name="phone"
					...
					<div class="row mb-6">
						...
						<!--begin::Col-->
						<div class="col-lg-8 fv-row">
							<Field v-model="profileDetails.companySite" type="text" name="website"
					...
					<div class="row mb-6">
						...
						<!--begin::Col-->
						<div class="col-lg-8 fv-row">
							<Field v-model="profileDetails.country" as="select" name="country"
					...
					<div class="row mb-6">
						...
						<div class="col-lg-8 fv-row">
							<!--begin::Input-->
							<Field v-model="profileDetails.language" as="select" name="language"
					...
					<div class="row mb-6">
						...
						<!--begin::Col-->
						<div class="col-lg-8 fv-row">
							<Field v-model="profileDetails.timezone" as="select" name="timezone"
								class="form-select form-select-solid form-select-lg">
					...
					<div class="row mb-6">
						...
						<!--begin::Col-->
						<div class="col-lg-8 fv-row">
							<Field v-model="profileDetails.currency" as="select" name="currency"
								class="form-select form-select-solid form-select-lg">
								<option value="USD">
									<b>USD</b>&#160;-&#160;USA dollar
								</option>
					...
					<div class="row mb-0">
						...
						<div class="col-lg-8 d-flex align-items-center">
							<div class="form-check form-check-solid form-switch fv-row">
								<input id="allowmarketing" class="form-check-input w-45px h-30px" type="checkbox">
			...
			<div class="card-body border-top p-9">
				...
				<div class="d-flex flex-wrap align-items-center mb-8">
					...
					<div id="kt_signin_password_button" class="ms-auto" :class="{ 'd-none': passwordFormDisplay }">
						<button class="btn btn-light fw-bolder" @click="passwordFormDisplay = !passwordFormDisplay">
							Reset Password
						</button>
					</div>
				</div>
			...
			<div class="card-body border-top p-9">
				...
				<div class="py-2">
					...
					<div class="d-flex flex-stack">
						<div class="d-flex">
							<img :src="getAssetPath('media/svg/brand-logos/google-icon.svg')" class="w-30px me-6"
								alt="">
						...
						<div class="d-flex justify-content-end">
							<div class="form-check form-check-solid form-switch">
								<input id="googleswitch" class="form-check-input w-45px h-30px" type="checkbox" checked>
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex justify-content-end">
							<div class="form-check form-check-solid form-switch">
								<input id="githubswitch" class="form-check-input w-45px h-30px" type="checkbox" checked>
								<label class="form-check-label" for="githubswitch" />
							</div>
						</div>
					</div>
					<!--end::Item-->
					...
					<div class="d-flex flex-stack">
						...
						<div class="d-flex justify-content-end">
							<div class="form-check form-check-solid form-switch">
								...
								<label class="form-check-label" for="slackswitch" />
							</div>
						</div>
					</div>
					<!--end::Item-->
		...
		<div id="kt_account_email_preferences" class="collapse show">
			...
			<form class="form" @submit.prevent="saveChanges3()">
				...
				<div class="card-body border-top px-9 py-9">
					...
					<label class="form-check form-check-custom form-check-solid align-items-start">
						<!--begin::Input-->
						<input class="form-check-input me-3" type="checkbox" name="email-preferences1" checked
							value="1">
						<!--end::Input-->
						...
						<table class="table table-row-dashed border-gray-300 align-middle gy-6">
							<tbody class="fs-6 fw-semibold">
								...
								<tr>
									...
									<td class="w-125px">
										<div class="form-check form-check-solid">
											<input id="kt_settings_notification_email" class="form-check-input"
												type="checkbox" value="" checked data-kt-check="true"
									...
									<td class="w-125px">
										<div class="form-check form-check-solid">
											<input id="kt_settings_notification_phone" class="form-check-input"
												type="checkbox" value="" checked data-kt-check="true"
								...
								<tr>
									...
									<td>
										<div class="form-check form-check-solid">
											<input id="billing1" class="form-check-input" type="checkbox" value="1"
												checked data-kt-settings-notification="email">
											<label class="form-check-label ps-2" for="billing1" />
										</div>
									</td>
									<td>
										<div class="form-check form-check-solid">
											<input id="billing2" class="form-check-input" type="checkbox" value=""
												checked data-kt-settings-notification="phone">
								...
								<tr>
									...
									<td>
										<div class="form-check form-check-solid">
											<input id="team1" class="form-check-input" type="checkbox" value="" checked
												data-kt-settings-notification="email">
											<label class="form-check-label ps-2" for="team1" />
										</div>
									</td>
									<td>
										<div class="form-check form-check-solid">
											<input id="team2" class="form-check-input" type="checkbox" value=""
												data-kt-settings-notification="phone">
											<label class="form-check-label ps-2" for="team2" />
										</div>
									</td>
								</tr>
								<!--begin::Table row-->
								...
								<tr>
									...
									<td>
										<div class="form-check form-check-solid">
											<input id="project1" class="form-check-input" type="checkbox" value=""
												data-kt-settings-notification="email">
											<label class="form-check-label ps-2" for="project1" />
										</div>
									</td>
									<td>
										<div class="form-check form-check-solid">
											<input id="project2" class="form-check-input" type="checkbox" value=""
												checked data-kt-settings-notification="phone">
											<label class="form-check-label ps-2" for="project2" />
										</div>
									</td>
								</tr>
								<!--begin::Table row-->
								...
								<tr>
									...
									<td class="border-bottom-0">
										<div class="form-check form-check-solid">
											<input id="newsletter1" class="form-check-input" type="checkbox" value=""
												data-kt-settings-notification="email">
											<label class="form-check-label ps-2" for="newsletter1" />
										</div>
									</td>
									<td class="border-bottom-0">
										<div class="form-check form-check-solid">
											<input id="newsletter2" class="form-check-input" type="checkbox" value=""
												data-kt-settings-notification="phone">
											<label class="form-check-label ps-2" for="newsletter2" />
										</div>
									</td>
								</tr>
								<!--begin::Table row-->
			...
			<form id="kt_account_deactivate_form" class="form" @submit.prevent="deactivateAccount()">
				...
				<div class="card-body border-top p-9">
						...
						<div class="d-flex flex-stack flex-grow-1">
							...
							<div class="fw-semibold">
								...
								<div class="fs-6 text-gray-600">
									...
									phone number when you reset yousignr password. <br><a class="fw-bold" href="#">Learn
										more</a>
								</div>
							</div>
							<!--end::Content-->
					...
					<div class="form-check form-check-solid fv-row">
						<input id="deactivate" name="deactivate" class="form-check-input" type="checkbox" value="">
						<label class="form-check-label fw-semibold ps-2 fs-6" for="deactivate">Confirm Account
							Deactivation</label>
					</div>
					<!--end::Form input row-->
				</div>
