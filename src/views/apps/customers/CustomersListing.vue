	...
	<div class="card">
		<div class="card-header border-0 pt-6">
			...
			<div class="card-toolbar">
				...
				<div class="d-flex justify-content-end align-items-center d-none"
					data-kt-customer-table-toolbar="selected">
					<div class="fw-bold me-5">
						<span class="me-2" data-kt-customer-table-select="selected_count" />Selected
					</div>
		...
		<div class="card-body pt-0">
			<Datatable :data="tableData" :header="tableHeader" :enable-items-per-page-dropdown="true"
				:checkbox-enabled="true" checkbox-label="id" @on-sort="sort" @on-items-select="onItemSelect">
...
export default defineComponent({
	...
	setup() {
		...
		function onItemSelect(selectedItems: Array<number>) {
