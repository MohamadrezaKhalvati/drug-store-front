					...
					<div class="py-2">
						...
						<div class="d-flex flex-stack">
							...
							<div class="d-flex justify-content-end">
								...
								<label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
									<!--begin::Input-->
									<input id="kt_modal_connected_accounts_google" class="form-check-input"
										name="google" type="checkbox" value="1" checked>
									<!--end::Input-->
						...
						<div class="d-flex flex-stack">
							...
							<div class="d-flex justify-content-end">
								...
								<label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
									<!--begin::Input-->
									<input id="kt_modal_connected_accounts_github" class="form-check-input"
										name="github" type="checkbox" value="1" checked>
									<!--end::Input-->
						...
						<div class="d-flex flex-stack">
							<div class="d-flex">
								<img :src="getAssetPath('media/svg/brand-logos/slack-icon.svg')" class="w-30px me-6"
									alt="">
							...
							<div class="d-flex justify-content-end">
								...
								<label class="form-check form-switch form-switch-sm form-check-custom form-check-solid">
									<!--begin::Input-->
									<input id="kt_modal_connected_accounts_slack" class="form-check-input" name="slack"
		...
		<div class="flex-lg-row-fluid ms-lg-15">
			...
			<div id="myTabContent" class="tab-content">
				...
				<div id="kt_customer_view_overview_tab" class="tab-pane fade show active" role="tabpanel">
					<PaymentRecords card-classes="mb-6 mb-xl-9" />

					<PaymentMethods card-classes="mb-6 mb-xl-9" />

					<CreditBalance card-classes="mb-6 mb-xl-9" />

					<Invoices card-classes="mb-6 mb-xl-9" />
				</div>
				<!--end:::Tab pane-->

				<!--begin:::Tab pane-->
				<div id="kt_customer_view_overview_events_and_logs_tab" class="tab-pane fade" role="tabpanel">
					<Logs card-classes="mb-6 mb-xl-9" />
					<Events card-classes="mb-6 mb-xl-9" />
				</div>
				<!--end:::Tab pane-->

				<!--begin:::Tab pane-->
				<div id="kt_customer_view_overview_statements" class="tab-pane fade" role="tabpanel">
					<Earnings card-classes="mb-6 mb-xl-9" />
					<Statement card-classes="mb-6 mb-xl-9" />
				</div>
				<!--end:::Tab pane-->
			</div>
			<!--end:::Tab content-->
