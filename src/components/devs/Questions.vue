<template>
	...
	<div class="mb-10">
		<template v-for="(question, i) in questions" :key="i">
				...
				<div class="d-flex flex-stack flex-wrap">
					...
					<div class="d-flex align-items-center py-1">
						...
						<a href="#" class="btn btn-sm btn-flex btn-light"
							:class="`${question.upvotes ? 'btn-icons' : 'px-3'}`" data-bs-toggle="tooltip"
							title="Upvote this question" data-bs-dismiss="click">
							{{ question.upvotes }}
							<KTIcon icon-name="black-right"
			...
			<!--begin::Separator-->
			<div class="separator separator-dashed border-gray-300 my-8" />
			<!--end::Separator-->
		</template>
