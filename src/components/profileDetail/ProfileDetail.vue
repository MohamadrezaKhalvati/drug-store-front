<template>
	<div class="card mb-5 mb-xl-10">
		<div class="card-header cursor-pointer">
			...
			<router-link to="/account/settings" class="btn bt-dark align-self-center fs-6">
				Edit Profile
			</router-link>
		</div>
		...
		<div class="card-body p-9">
			...
			<div class="row mb-7">
				...
				<div class="col-lg-8 d-flex align-items-center">
					<span class="fw-bold fs-6 me-2">(555) 123-4567</span>
				</div>
			</div>
			<div class="row mb-7">
				<label class="col-lg-4 fw-semibold text-muted">Address</label>
				<div class="col-lg-8">
					<a href="#" class="fw-bold fs-6 text-dark text-hover-primary">123 Main St, Springfield, IL</a>
				</div>
			</div>
			<div class="row mb-7">
				<label class="col-lg-4 fw-semibold text-muted">
				...
				<div class="col-lg-8">
					<span class="fw-bold fs-6 text-gray-900">January 1, 1980</span>
				</div>
			</div>
		</div>
	</div>
	...
	<!--  Save All Button -->
	<div class="my-10">
		<button class="btn bt-dark align-self-center fs-4 ">
