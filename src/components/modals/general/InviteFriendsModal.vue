<template>
	...
	<div id="kt_modal_invite_friends" class="modal fade" tabindex="-1" aria-hidden="true">
		<!--begin::Modal dialog-->
			...
			<div class="modal-content">
				...
				<div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
					...
					<div class="separator d-flex flex-center mb-8">
						<span class="text-uppercase bg-body fs-7 fw-semibold text-gray-400 px-3">or</span>
					</div>
					<!--end::Separator-->
								...
								<div class="d-flex flex-stack py-4 border-bottom border-gray-300 border-bottom-dashed">
									...
									<div class="d-flex align-items-center">
										...
										<div class="symbol symbol-35px symbol-circle">
											...
											<span v-else :class="`bg-light-${user.state} text-${user.state}`"
