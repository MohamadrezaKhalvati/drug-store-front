				...
				<div class="modal-body scroll-y pt-0 pb-15">
					...
					<div class="mw-lg-600px mx-auto">
						...
						<div class="mb-10">
							...
							<!--begin::Title-->
							<div class="d-flex">
								<input ref="inputRef" id="kt_share_earn_link_input" type="text"
									class="form-control form-control-solid me-3 flex-grow-1" name="search"
									value="https://keenthemes.com/?ref=skitechnology" />

								<button ref="copyButtonRef" id="kt_share_earn_link_copy_button"
						...
						<div class="d-flex">
							<a href="#" class="btn btn-light-primary w-100">
								<img alt="Logo" :src="getAssetPath('media/svg/brand-logos/google-icon.svg')"
									class="h-15px me-3" />
								Import Contacts
							</a>
					
							<a href="#" class="btn btn-icon btn-facebook w-100 mx-6">
								<img alt="Logo" :src="getAssetPath('media/svg/brand-logos/facebook-2.svg')"
									class="h-20px me-3" />
								Facebook
							</a>

							<a href="#" class="btn btn-icon btn-twitter w-100">
								<img alt="Logo" :src="getAssetPath('media/svg/brand-logos/twitter.svg')"
									class="h-20px me-3" />
								Twitter
							</a>
						</div>
						...
						<div class="d-flex align-items-center mt-10">
							...
							<div class="flex-grow-1">
								...
								<span class="fs-7 fw-semibold text-gray-500">If you need more info, please check budget
									planning</span>
							</div>
							<!--end::Label-->
