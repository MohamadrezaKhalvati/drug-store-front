<template>
	...
	<div id="kt_modal_two_factor_authentication" class="modal fade" tabindex="-1" aria-hidden="true">
		<!--begin::Modal header-->
			...
			<div class="modal-content">
				...
				<div class="modal-body scroll-y pt-10 pb-15 px-lg-17">
					...
					<div :class="[state !== '' && 'd-none']">
						...
						<div class="pb-10">
							<!--begin::Option-->
							<input id="kt_modal_two_factor_authentication_option_1" v-model="value" type="radio"
								class="btn-check" name="auth_option" value="apps" checked>
							<label
							...
							<!--begin::Option-->
							<input id="kt_modal_two_factor_authentication_option_2" v-model="value" type="radio"
								class="btn-check" name="auth_option" value="sms">
							<label
					...
					<div :class="[state !== 'apps' && 'd-none']" data-kt-element="apps">
						...
						<!--begin::Form-->
						<VForm class="form" :validation-schema="schema2" @submit="submitAuthCodeForm()">
							<!--begin::Input group-->
							...
							<div class="d-flex flex-center">
								<button type="reset" class="btn btn-light me-3" @click="state = ''">
									Cancel
								</button>

								<button ref="submitAuthCodeButtonRef" type="submit" data-kt-element="apps-submit"
					...
					<div :class="[state !== 'sms' && 'd-none']" data-kt-element="sms">
						...
						<!--begin::Form-->
						<VForm class="form" :validation-schema="schema1" @submit="submitMobileForm()">
							<!--begin::Input group-->
							<div class="mb-10 fv-row">
								<Field type="text" class="form-control form-control-lg form-control-solid"
							...
							<!--begin::Actions-->
							<div class="d-flex flex-center">
								<button class="btn btn-light me-3" @click="state = ''">
									Cancel
								</button>

								<button ref="submitMobileButtonRef" type="submit" data-kt-element="sms-submit"
									class="btn btn-primary">
									<span class="indicator-label"> Submit </span>
									<span class="indicator-progress">
										Please wait...
